                ...
                <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="account-tab" data-bs-toggle="tab" data-bs-target="#account"
                            type="button" role="tab" aria-controls="hoaccountme" aria-selected="true">
                            Tus datos
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" class="form-control" id="correo"
                                            placeholder="example@neptune.com" name="correo"
                                            value="<?php echo $data['usuario']['correo']; ?>">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="telefono" class="form-label">Phone Number</label>
                                        <input type="text" class="form-control" id="telefono"
                                            placeholder="(xxx) xxx-xxxx" name="telefono"
                                            value="<?php echo $data['usuario']['telefono']; ?>">
                                    </div>
                                </div>
                                <div class="row m-t-lg">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="nombre" name="nombre"
                                            placeholder="John" value="<?php echo $data['usuario']['nombre']; ?>">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="apellido" class="form-label">Last Name</label>
                                        <input type="text" class="form-control" id="apellido" name="apellido"
                                            placeholder="Doe" value="<?php echo $data['usuario']['apellido']; ?>">
                                    </div>
                                </div>
                                <div class="row m-t-lg">
                                    <div class="col">
                                        <label for="direccion" class="form-label">Dirección</label>
                                        <textarea class="form-control" id="direccion" name="direccion" maxlength="500"
                                            rows="4"><?php echo $data['usuario']['direccion']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row m-t-lg">
                                    <div class="col">
                                        <button tyoe="submit" href="#" class="btn btn-primary m-t-sm">Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row m-t-xxl">
                                    <div class="col-md-6">
                                        <label for="settingsCurrentPassword" class="form-label">Contraeña actual</label>
                                ...
                                <div class="row m-t-xxl">
                                    <div class="col-md-6">
                                        ...
                                        <input type="password" class="form-control" id="clave_confirmar"
                                            name="clave_confirmar" placeholder="Confirmar contraseña">
                                    </div>
                                </div>
                                <div class="row m-t-lg">
                                    <div class="col">

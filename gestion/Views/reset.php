        ...
        <div class="app-auth-container">
            ...
            <form id="formulario" autocomplete="off">
                ...
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input type="password" class="form-control m-b-md" id="clave_nueva" name="clave_nueva"
                        placeholder="Contraseña nueva">

                    <label for="clave" class="form-label">Confirmar contraseña <span class="text-danger">*</span></label>
                    <input type="password" class="form-control" id="clave_confirmar" name="clave_confirmar" aria-describedby="clave"
